...
const Login = () => {
  ...
  return (
    <div className="w-[430px] bg-white p-8 rounded-2xl shadow-lg">
        ...
        {/*Tab control */}
        <div className="relative flex h-12 border border-gray-300 rounded-full overflow-hidden">
        ...
        <form className="space-y-4">
            ...
            {/* Switch link */}
            <p className="text-center text-gray-600 ">{isLoginMode ? "Don't have account" : "Already have an account"}
